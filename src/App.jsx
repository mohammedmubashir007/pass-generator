...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-5 text-orange-500 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button
            ...
            className='outline-none bg-blue-700 text0-white px-3 py-0.5 shrink-0' >Copy</button>
        </div>
